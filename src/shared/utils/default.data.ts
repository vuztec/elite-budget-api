...
export const debt_data = [
  ...
  { description: 'Enter', Category: DEBT_CATEGORY.CREDIT_CARD },
  { description: 'Enter', Category: DEBT_CATEGORY.CREDIT_CARD },
  ...
  { description: 'Enter', Category: DEBT_CATEGORY.DEPARTMENT_STORE },
  { description: 'Enter', Category: DEBT_CATEGORY.DEPARTMENT_STORE },
  { description: 'Family/Friend Loan Payment', Category: DEBT_CATEGORY.FAMILY_FRIEND_LOAN },
  { description: 'Family/Friend Loan Payment', Category: DEBT_CATEGORY.FAMILY_FRIEND_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.FAMILY_FRIEND_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.FAMILY_FRIEND_LOAN },
  {
  ...
  { description: 'Enter', Category: DEBT_CATEGORY.MEDICAL_DEBT },
  { description: 'Enter', Category: DEBT_CATEGORY.MEDICAL_DEBT },
  { description: 'Personal Loan Payment', Category: DEBT_CATEGORY.PERSONAL_LOAN },
  { description: 'Personal Loan Payment', Category: DEBT_CATEGORY.PERSONAL_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.PERSONAL_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.PERSONAL_LOAN },
  { description: 'Student Loans', Category: DEBT_CATEGORY.STUDENT_LOAN },
  { description: 'Student Loans', Category: DEBT_CATEGORY.STUDENT_LOAN },
  { description: 'Student Loans', Category: DEBT_CATEGORY.STUDENT_LOAN },
  { description: 'Student Loans', Category: DEBT_CATEGORY.STUDENT_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.STUDENT_LOAN },
  { description: 'Enter', Category: DEBT_CATEGORY.STUDENT_LOAN },
...
export const expenses_data = [
  ...
  { Category: EXPENSES_CATEGORY.PARENT_ELDER_CARE, Description: 'Parents Support' },
  { Category: EXPENSES_CATEGORY.PARENT_ELDER_CARE, Description: 'Parents Support' },
  { Category: EXPENSES_CATEGORY.PARENT_ELDER_CARE, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.PARENT_ELDER_CARE, Description: 'Enter' },
  ...
  { Category: EXPENSES_CATEGORY.HEALTH_MEDICAL, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.OTHER_INSURANCE, Description: 'Collectibles Insurance' },
  { Category: EXPENSES_CATEGORY.OTHER_INSURANCE, Description: 'Long Term Care Insurance' },
  ...
  { Category: EXPENSES_CATEGORY.VACATIONS, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.VACATIONS, Description: 'Enter' },
  ...
  { Category: EXPENSES_CATEGORY.RENTAL_PROPERTY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.RENTAL_PROPERTY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.RENTAL_PROPERTY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.RENTAL_PROPERTY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.RENTAL_PROPERTY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.ALIMONY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.ALIMONY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.ALIMONY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.ALIMONY, Description: 'Enter' },
  { Category: EXPENSES_CATEGORY.ALIMONY, Description: 'Enter' },
...
export const goals_data = [
  ...
  { Category: EXPENSES_CATEGORY.HEALTH_MEDICAL, Percentage: 5.0, Type: GOAL_TYPE.EXPENSE },
  { Category: EXPENSES_CATEGORY.HOUSEHOLD_PERSONAL_CARE_AND_GIFTS, Percentage: 10.0, Type: GOAL_TYPE.EXPENSE },
